      ...
      <WrapperInner>
        <WrapperProfilePicture>
          {convoPartnerProfileImg ? (
            <ProfileImage imageSrc={convoPartnerProfileImg} />
          ) : (
            <AccountCircleIcon />
          )}
        </WrapperProfilePicture>
          ...
          <>
            <WrapperConvoContent>
              {convoPartner.firstName && convoPartner.lastName ? (
                <WrapperConvoPartner>
                  {`${capitaliseString(convoPartner.firstName) +
                    ' ' +
                    capitaliseString(convoPartner.lastName)}`}
                </WrapperConvoPartner>
              ) : null}
              <WrapperConvoSnippet>{convoSnippet}</WrapperConvoSnippet>
            </WrapperConvoContent>
            <WrapperConvoTime>{convoLastMessageTime}</WrapperConvoTime>
          </>
        ) : (
          <>
            <WrapperConvoContent>
